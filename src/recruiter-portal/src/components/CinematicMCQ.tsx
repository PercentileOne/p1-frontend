...
export interface MCQQuestion {
  questionText: string;
  options: string[];      // 4 options, each prefixed "A. ", "B. " etc
...
export default function CinematicMCQ({ mcq, candidateName, onComplete }: Props) {
  ...
  const handleOption = useCallback((index: number) => {
    ...
    if (index === mcq.correctIndex) {
      ...
      // Confetti after a tiny tick so canvas is visible
      setTimeout(() => {
      ...
      {mcqState !== 'exiting' && (
        ...
        >
          ...
          >
            ...
            {/* Icon */}
            <motion.div
              animate={mcqState === 'answered-correct' ? { scale: [1, 1.25, 1], rotate: [0, -10, 10, 0] } : {}}
            ...
            <AnimatePresence>
              {mcqState === 'answered-correct' && (
                ...
                >
                  ...
                  <div style={{ fontSize: '13px', color: 'rgba(240,244,255,0.65)', lineHeight: 1.5 }}>
                    Brilliant answer. Back to your interview shortly…
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
            ...
            <AnimatePresence>
              {mcqState === 'answered-wrong' && (
                ...
                >
                  ...
                  <div style={{ fontSize: '12px', color: 'rgba(240,244,255,0.4)', marginTop: '10px' }}>
                    No worries — back to your interview shortly…
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
              ...
              {bonusVisible && (
                <motion.div
                  ...
                  style={{
                    ...
                    fontSize: '32px', fontWeight: 900, color: '#34D399',
