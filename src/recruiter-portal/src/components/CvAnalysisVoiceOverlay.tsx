...
// Copy-trimmed from the candidate portal's CvAnalysisVoiceOverlay.tsx — same glow/avatar
// treatment, plain TTS (no LiveAvatar) per Francis's own steer for this feature: cost-conscious,
// and this is the pattern already proven for "AI voice explains something to you" elsewhere in
// the product. narrativeScript is genuinely AI-written per-CV, so it's split into sentences here
// rather than pre-authored as an array of lines.
