...
<body>
  <div class="header">
    <div class="brand">InterviewMe · Interview Pack</div>
    <h1>${pack.title}</h1>
    <div class="meta">Generated ${date} · ${pack.questions.length} questions</div>
  </div>
  ${questionsHtml}
  <div class="footer">Generated by InterviewMe · interviewme.global · Confidential — for interview preparation only</div>
</body>
</html>`;
