    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#080E1C', color: '#FFFFFF', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '40px 24px 80px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 40 }}>
          <button onClick={() => navigate('/candidate')} style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.10)', borderRadius: 10, padding: '8px 14px', color: 'rgba(255,255,255,0.60)', cursor: 'pointer', fontSize: 14, fontWeight: 600 }}>
            ← Back
          </button>
          <div style={{ flex: 1 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div>
                <div style={{ fontSize: 13, fontWeight: 800, letterSpacing: 1.5, color: 'rgba(255,255,255,0.35)', textTransform: 'uppercase' }}>Explain · Learn Engine</div>
              </div>
            </div>
          </div>
