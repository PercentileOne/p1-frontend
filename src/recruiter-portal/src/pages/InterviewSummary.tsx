      ...
      {chapters.length > 0 && (
        <div style={{ padding: '12px 16px', display: 'flex', flexDirection: 'column', gap: '6px' }}>
          ...
          {chapters.map((c, i) => {
            ...
            // values (-2, -1) — see InterviewRoom.tsx's startMike/beginInterviewIntro — so
            // they're jumpable from this list too, styled distinctly from real questions.
...
${questionsHtml}
<div class="footer">Generated by InterviewMe · interviewme.global · For interview preparation only</div>
</body></html>`;
