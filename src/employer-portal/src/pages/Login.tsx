      ...
      <div style={{
        ...
        >
          ...
          <div style={{ fontSize: 14, color: '#64748b', marginTop: 6, lineHeight: 1.5 }}>
            Discover candidates who've already<br />proven they're ready.
          </div>
        </motion.div>
        ...
        >
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p style={{ textAlign: 'center', fontSize: 11, color: '#334155', marginTop: 6, lineHeight: 1.5 }}>
                Employer accounts are set up by our team — there's no self-registration here.
              </p>
            </motion.form>
          </AnimatePresence>
        </motion.div>
