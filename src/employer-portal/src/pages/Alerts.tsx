    ...
    <div>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
        ...
        <button
          ...
          style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '10px 18px', background: '#34D399', color: '#06210f', border: 'none', borderRadius: 8, fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit' }}
        >
        ...
        {(['alerts', 'matches'] as const).map(t => (
          <button
            ...
            style={{
              ...
              borderBottom: `2px solid ${tab === t ? '#34D399' : 'transparent'}`,
      ...
      <div style={{ width: '100%', maxWidth: 420, maxHeight: '90vh', overflowY: 'auto', background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 16, padding: 24 }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          <Field label="Role">
            <div style={{ position: 'relative' }}>
              ...
              {showRoleSuggestions && (searchingRole || roleSuggestions.length > 0) && (
                <div style={{ position: 'absolute', top: 'calc(100% + 6px)', left: 0, right: 0, background: '#0d0c1e', border: '1px solid rgba(52,211,153,0.3)', borderRadius: 10, overflowY: 'auto', overflowX: 'hidden', maxHeight: 236, zIndex: 20, boxShadow: '0 16px 48px rgba(0,0,0,0.6)' }}>
                  {searchingRole ? (
                    ...
                    <div
                      ...
                      onMouseEnter={e => { (e.currentTarget as HTMLDivElement).style.background = 'rgba(52,211,153,0.1)' }}
          ...
          <div style={{ display: 'flex', gap: 10, marginTop: 6 }}>
            ...
            <button type="submit" disabled={saving} style={{ flex: 1, padding: '10px 16px', borderRadius: 9, fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit', background: '#34D399', color: '#06210f', border: 'none', opacity: saving ? 0.7 : 1 }}>
...
const inputStyle: React.CSSProperties = {
  ...
  padding: '9px 12px', color: 'var(--text)', fontSize: 13, outline: 'none', caretColor: '#34D399', width: '100%', boxSizing: 'border-box',
}
