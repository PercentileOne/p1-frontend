...
const TOKEN_KEY = 'explain_admin_token';
const ADMIN_PERMISSION = 'CAN_VIEW_ADMIN_PORTAL';
...
interface AuthContextValue {
  ...
  token:      string | null;
  isLoading:  boolean;
  /** Validates a token against the shared backend before trusting it. Throws if invalid or lacking admin access. */
